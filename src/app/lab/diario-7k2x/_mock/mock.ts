    ...
    entries: [
      {
        ...
        itens: [
          { id: nextId("item"), foodId: "pao", nome: "Pão francês", categoria: "carboidrato", gramas: 50, confianca: 0.95, fonte: "taco" },
          { id: nextId("item"), foodId: "ovo", nome: "Ovo frito", categoria: "proteina", gramas: 55, confianca: 0.9, fonte: "taco" },
          { id: nextId("item"), foodId: "banana", nome: "Banana prata", categoria: "fruta", gramas: 85, confianca: 0.93, fonte: "taco" },
          { id: nextId("item"), foodId: "cafe", nome: "Café com açúcar", categoria: "bebida", gramas: 150, confianca: 0.7, fonte: "ia_estimado" },
        ],
      },
    ],
  };
